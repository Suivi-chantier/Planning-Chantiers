...
// ─── HTML DU SIMULATEUR (injecté dans l'iframe) ───────────────────────────────
// C'est le fichier de ton collègue, avec 3 modifications minimes :
//   1. On supprime le header (on utilise celui de React)
//   2. On remplace saveProject() / loadProject() par des postMessage vers React
//   3. On ajoute un listener pour recevoir loadState depuis React
