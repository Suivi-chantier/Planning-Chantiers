-- Suivi serveur des liaisons/créations de la bibliothèque ProGBat.
-- Aucun accès navigateur : la table est manipulée uniquement par service_role
-- dans l'Edge Function progbat-library-sync.
